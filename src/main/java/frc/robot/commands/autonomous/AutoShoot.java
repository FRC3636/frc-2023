...
public class AutoShoot extends SequentialCommandGroup {
    public AutoShoot(Drivetrain drivetrain, Arm arm, PoseEstimation poseEstimation, Supplier<Node> targetNode){
        this.addCommands(
                new AlignToSelectedNode(drivetrain, arm, poseEstimation, targetNode, 0.75)
                        .raceWith(
                                new SequentialCommandGroup(
                                        ...
                                        new InstantCommand(() -> arm.setRollerState(Rollers.State.shoot)),
